...
// let chislo = prompt("Введіть трьохзначне число");//123
// let result = chislo % 10; //3
// let first = result;
// chislo = chislo / 10; //12.3
// let chisloTwo = Math.floor(chislo) % 10;//2
// let chisloThree = chislo / 10; //1.2
